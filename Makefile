...
# Forward migrations
db-migrate: db-migrate-init db-migrate-profiles db-migrate-comments db-migrate-gallery db-migrate-author
...
db-migrate-author:
	@echo "Running gallery author migration (009)..."
	docker exec -i quoteyouros_db psql -U postgres -d quoteyouros < migrations/009_add_author_to_gallery.sql

# Revert migrations
db-migrate-revert: db-migrate-revert-author db-migrate-revert-gallery db-migrate-revert-comments db-migrate-revert-profiles db-migrate-revert-all
...
db-migrate-revert-author:
	@echo "Reverting gallery author migration (010)..."
	docker exec -i quoteyouros_db psql -U postgres -d quoteyouros < migrations/010_revert_add_author_to_gallery.sql
